...
set CLASSPATH=%APP_HOME%\lib\code-1.0-SNAPSHOT.jar;%APP_HOME%\lib\mysql-connector-java-8.0.28.jar


@rem Execute code
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %CODE_OPTS%  -classpath "%CLASSPATH%" it.unicam.cs.main.App %*
